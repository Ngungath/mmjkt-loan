...
<section class="content">
   <form role="form" id="register_form" method="post" action="{{route('borrower.store')}}" enctype="multipart/form-data">  
	<div class="nav-tabs-custom">
            ...
            <div class="row">
              ...
              <!-- Button nex borrower details -->
                <br />
                <div align="center">
                  <button type="button" name="btn_personal_detail" id="btn_personal_detail" class="btn btn-info btn-lg">Next >>>></button>
                      </div>
              <!-- Button nex borrower details -->
              </div>
              <!-- /.tab-pane -->
                ...
                <div class="col col-md-12">
                  <div class="col-md-6">
                   <div class="form-group">
                    ...
                    <input type="text" name="monthly_net_salary" id="monthly_net_salary" class="form-control">
        ...
        <br />
        <div align="center">
        <button type="button" name="previous_btn_personal_details" id="previous_btn_borrower_details" class="btn btn-default btn-lg">Previous</button>
         <button type="button" name="btn_employment_details" id="btn_employment_details" class="btn btn-success btn-lg">Register Borrower</button>
        </div>
        <br />
        </div>
        <br />
